...
{
    /// <summary>
    /// Modified ScrollInfoAdapter to make it smooth
    /// </summary>
    public class ScrollInfoAdapter : UIElement, IScrollInfo
    {
        ...
        {
            DoubleAnimationUsingKeyFrames keyFramesAnimation = new()
            {
        ...
        {
            if (Math.Abs(_computedVerticalOffset - ValidateVerticalOffset(val)) > 0.1)
            {
        ...
        {
            if (Math.Abs(_computedHorizontalOffset - ValidateHorizontalOffset(val)) > 0.1)
            {
        ...
        {
            ScrollInfoAdapter smoothScrollViewer = (ScrollInfoAdapter)d;

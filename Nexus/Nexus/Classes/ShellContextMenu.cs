...
namespace Nexus.Classes
{
    ...
    public class ShellContextMenu : NativeWindow
    {
        ...
        private void InvokeCommand(IContextMenu oContextMenu, uint nCmd, string? strFolder, System.Windows.Point pointInvoke)
        {
        ...
        private void InvokeContextMenuDefault(FileInfo[] arrFI)
        {
            ...
            try
            {
                ...
                {
                    InvokeCommand(_oContextMenu, nDefaultCmd, arrFI[0].DirectoryName, new System.Windows.Point(Control.MousePosition.X, Control.MousePosition.Y));
                }
